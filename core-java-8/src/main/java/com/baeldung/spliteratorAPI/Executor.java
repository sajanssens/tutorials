...
public class Executor {
    ...
    public static int countAuthors(Stream<Author> stream) {
        RelatedAuthorCounter wordCounter = stream
                .reduce(new RelatedAuthorCounter(0, true),
    ...
    public static List<Article> generateElements() {
        return Stream.generate(() -> new Article("Java")).limit(35_000).collect(Collectors.toList());
    }
